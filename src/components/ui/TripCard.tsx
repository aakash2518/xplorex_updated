...
const TripCard = ({ name, slug, tagline, img, tripsCount, startingPrice, index }: TripCardProps) => (
  <motion.div
  ...
  >
    <Link
      ...
      className="group relative block rounded-2xl sm:rounded-3xl overflow-hidden shadow-3d aspect-[3/4] border border-primary/10"
    >
      <Image
        src={img}
        alt={name}
