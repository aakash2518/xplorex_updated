  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float": { "0%,100%": { transform: "translateY(0) rotate(0)" }, "50%": { transform: "translateY(-20px) rotate(2deg)" } },
        "float-slow": { "0%,100%": { transform: "translateY(0) translateX(0)" }, "50%": { transform: "translateY(-30px) translateX(10px)" } },
        "plane-fly": { "0%": { transform: "translate(-20%, 30%) rotate(-15deg)", opacity: "0" }, "10%,90%": { opacity: "1" }, "100%": { transform: "translate(120%, -50%) rotate(-15deg)", opacity: "0" } },
        "pulse-glow": { "0%,100%": { boxShadow: "0 0 0 0 hsl(246 80% 55% / 0.5)" }, "50%": { boxShadow: "0 0 0 24px hsl(246 80% 55% / 0)" } },
